...
export const books = {
  Comics: [
    {
      title: "The Amazing Spiderman By Nick Spencer Vol. 1: Back To Basics (MARVEL ORIGINAL COMIC)",
      price: 1.99,
      rating: 4,
      image: Spidey1,
      about:
    ...
    {
      title: "The Amazing Spiderman By Nick Spencer Vol. 2: Friends And Foes (MARVEL ORIGINAL COMIC)",
      price: 19.99,
      rating: 5,
      image: Spidey2,
      about:
    ...
    {
      title: "The Amazing Spiderman By Nick Spencer Vol. 3: Lifetime Achievement (MARVEL ORIGINAL COMIC)",
      price: 2.99,
      rating: 1,
      image: Spidey3,
      about:
    ...
    {
      title: "The Amazing Spiderman By Nick Spencer Vol. 4: Hunted (MARVEL ORIGINAL COMIC)",
      price: 8.99,
      rating: 3,
      image: Spidey4,
      about:
  ...
  Dictionaries: [
    {
      title: "Oxford English Dictionary (3rd Edition)",
      price: 65.29,
      rating: 5,
      image: Dictionary,
      about:
